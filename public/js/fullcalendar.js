		...
		$.each(
			{
				...
				taphold: function(seg, ev) {
					console.log("taphold");
					return view.trigger('eventTapHold', this, seg.event, ev); // can return `false` to cancel
				},
				tap: function(seg, ev) {
					console.log("tap");
					return view.trigger('eventTap', this, seg.event, ev); // can return `false` to cancel
				},
